...
\textcolor{teal}{Y's roughtidea for max'l alb case}
When $X$ is max'l alb and there exists 
$\omega$ such that $Z(f^*\omega) = \emptyset$ we know $a(X)$ is fibered by tori $B$ of non-resonant forms. In particular
$\omega\in H^0(B, \Omega_B^1)$. Now if $D^i$'s are fibered
by tori, they must be fibered by subvarieties of $B$. 
\textcolor{teal}{end of Y's rough idea}
