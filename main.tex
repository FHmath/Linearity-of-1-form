...
admit cohomologies in any degree (see \textit{loc.\ cit.} or \cite[Theorem 4.2]{Sim93b} for a proof). Therefore, these forms are precisely the ones that do not fall in the
