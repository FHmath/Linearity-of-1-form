...
\end{definition}  
With the above definition, we define $$V_{H\textnormal{-neg}}(X):=\{\omega\in H^0(X, \Omega_X^1)\ |\ \omega(p)=0\  \textnormal{for any point}\ p\in E, \ \textnormal{with negative divisor}\  E\}$$  $$V_{\textnormal{neg}}(X):=\bigcap_{H\ \textnormal{ample divisor}}V_{H\textnormal{-neg}}(X),$$ where the intersection runs over all ample divisors of $X$.
