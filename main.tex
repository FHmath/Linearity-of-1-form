...
\begin{remark}
(1) {\color{red}Add If the albanese variety of $X$ is simple, then Theorem A implies Kotschick's conj.........}

(2) {\color{red} Add conterexample $E_1\times E_2\times E_3$ and blowup translated $E_1$ and $E_3$............}
\end{remark}
