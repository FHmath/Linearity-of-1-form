...
\begin{remark}
(1) By \cite[Lemma 2.8]{MiSh18}, in the above definition an $i-1$-dimensional subspace $W$ of $T_yY$ is transversal to $f_{\dagger}(0_X)$ means 
\[df_x(T_xX)+W=T_yY,\]
...
(3) $\Delta^i(f)$ are closed \sorry{reference?} subvarieties of $Y$, which measure how singular $f$ can be.
