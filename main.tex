...
By lemma \ref{countable} and $V^1(X)$ being algebraic, we have that $V_{\textnormal{neg}}$ is a linear subvariety of $H^0(X, \Omega_X)$. Also, since $T_h^1(X)$ is a linear subvariety, $V^1(X)$ is a linear subvariety.
 \end{proof} 
